WITH user_group_messages AS
 ...
 SELECT hk_group_id,
   ...
   FROM stv2023121113__DWH.l_user_group_activity luga
 ...
 SELECT hk_group_id,
   ...
   FROM stv2023121113__DWH.l_user_group_activity luga
   LEFT JOIN stv2023121113__DWH.s_auth_history sah ON luga.hk_l_user_group_activity = sah.hk_l_user_group_activity
   WHERE sah.event = 'add'
...
LEFT JOIN stv2023121113__DWH.h_groups AS hg ON ugl.hk_group_id = hg.hk_group_id
WHERE ugm.hk_group_id in
    (SELECT hk_group_id
     FROM stv2023121113__DWH.h_groups hg2
